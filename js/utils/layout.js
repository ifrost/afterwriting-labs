...
define(['jquery', 'templates', 'modules/data', 'handlebars', 'utils/pluginmanager', 'utils/common', 'templates', 'utils/decorator', 'impromptu'], function ($, temlates, data, Handlebars, pm, common, templates, decorator, impromptu) {
