...
define(function(require) {
    ...
    var Monitor = Module.extend({
        ...
        windup: function() {
            ...
            layout.toggle_expand.add(this.track_handler('feature', 'expand'));

            // info
            info.download_clicked.add(this.track_handler('feature', 'download'));
            ...
            open.create_new.add(this.track_handler('feature', 'open-new'));
            open.open_file_dialog.add(this.track_handler('feature', 'open-file-dialog'));
            ...
            // save
            save.save_as_fountain.add(this.track_handler('feature', 'save-fountain'));
            save.save_as_pdf.add(this.track_handler('feature', 'save-pdf'));
            save.dropbox_fountain.add(this.track_handler('feature', 'save-fountain-dropbox'));
            save.google_drive_fountain.add(this.track_handler('feature', 'save-fountain-googledrive'));
            save.dropbox_pdf.add(this.track_handler('feature', 'save-pdf-dropbox'));
            save.google_drive_pdf.add(this.track_handler('feature', 'save-pdf-googledrive'));

            // stats
            stats.goto.add(this.track_handler('feature', 'stats-scene-length-goto'));
