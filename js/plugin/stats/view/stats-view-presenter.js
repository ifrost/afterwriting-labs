define(function(require) {
    ...
    var StatsViewPresenter = BaseSectionViewPresenter.extend({
        ...
        activate: function() {
            ...
            statsData.days_and_nights = queries.days_and_nights.run(this.scriptModel.parsed_stats.tokens, this.scriptModel.config.stats_keep_last_scene_time);
            statsData.int_and_ext = queries.int_and_ext.run(this.scriptModel.parsed_stats.tokens);
            statsData.scenes = queries.scene_length.run(this.scriptModel.parsed_stats.tokens, this.scriptModel.config.stats_keep_last_scene_time);
